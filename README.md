...
```bash
node "C:/Program Files/DSH Desktop/resources/app.asar.unpacked/lib/desktop-cli.js" plugin --profile desktop add <本仓库绝对路径>
```
...
1. 将本仓库复制到 `~/.dsh/profiles/desktop/node_modules/@lihua/dsh-mcp-manager`
